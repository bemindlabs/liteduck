...
//!
//! Notes are stored as markdown files with YAML frontmatter. Supports
//! wikilinks (`[[note]]`), tags, backlink resolution, and keyword scoring.
//!
//! The global memory layer (`~/.liteduck/memory/`) is driven by `home.rs`,
//! which reuses the parsing/rendering/indexing helpers exposed here.
