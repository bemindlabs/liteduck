...
pub fn run() {
    ...
    builder
        .invoke_handler(tauri::generate_handler![
            ...
            terminal::terminal_list_tmux,
            terminal::terminal_attach,
            terminal::terminal_kill_tmux,
            terminal::terminal_rename_tmux,
            terminal::terminal_tmux_split,
            terminal::terminal_tmux_new_window,
            terminal::terminal_tmux_next_window,
            terminal::terminal_tmux_prev_window,
