...
export const COMMANDS: Command[] = [
  ...
  {
    id: "action-editor-close-tab",
    title: "Close Editor Tab",
    category: "Actions",
    icon: "X",
    shortcut: "⌘W",
    keywords: ["close", "editor", "tab", "file"],
  },
  {
    id: "action-editor-close-all",
    title: "Close All Editor Tabs",
    category: "Actions",
    icon: "X",
    keywords: ["close", "all", "editor", "tabs", "files"],
  },
  {
    id: "action-editor-reopen",
  ...
  {
    id: "action-editor-pin",
    title: "Pin / Unpin Editor Tab",
    category: "Actions",
    icon: "Pin",
    keywords: ["pin", "unpin", "stick", "editor", "tab"],
  },
  {
    id: "action-editor-next",
    title: "Next Editor Tab",
    category: "Actions",
    icon: "ArrowRight",
    keywords: ["next", "forward", "cycle", "editor", "tab"],
  },
  {
    id: "action-editor-prev",
    title: "Previous Editor Tab",
    category: "Actions",
    icon: "ArrowLeft",
    keywords: ["previous", "prev", "back", "cycle", "editor", "tab"],
  },
  {
    id: "action-split-h",
